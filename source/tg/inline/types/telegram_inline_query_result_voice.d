/**
 * Contains TelegramInlineQueryResultVoice
 */
module tg.inline.types.telegram_inline_query_result_voice;
 ...
 */
class TelegramInlineQueryResultVoice : TelegramType {
    /**
    ...
    override public void setFromJson (JSONValue data) {
        ...
        if ( "voice_url" !in data ) throw new TelegramException("Could not find reqired entry : voice_url");
        _voice_url = data["voice_url"].str();
        ...
        if ( "voice_duration" in data )
        _voice_duration = data["voice_duration"].integer();
    ...
    override public JSONValue getAsJson () {
        ...
        if ( _voice_duration != 0 ) data["voice_duration"] = _voice_duration;
    ...
    /**
     * Getter for '_voice_url'
     * Returns: Current value of '_voice_url'
     */
    @property string voiceUrl () { return _voice_url; }
    /**
     * Setter for '_voice_url'
     * Params: voiceUrlNew = New value of '_voice_url'
     * Returns: New value of '_voice_url'
     */
    @property string voiceUrl ( string voiceUrlNew ) { return _voice_url = voiceUrlNew; }
    ...
    /** <em>Optional</em>. Mode for parsing entities in the voice message caption. See formatting options for more details. */
    ...
    private ulong _voice_duration;
    /**
     * Getter for '_voice_duration'
     * Returns: Current value of '_voice_duration'
     */
    @property ulong voiceDuration () { return _voice_duration; }
    /**
     * Setter for '_voice_duration'
     * Params: voiceDurationNew = New value of '_voice_duration'
     * Returns: New value of '_voice_duration'
     */
    @property ulong voiceDuration ( ulong voiceDurationNew ) { return _voice_duration = voiceDurationNew; }
