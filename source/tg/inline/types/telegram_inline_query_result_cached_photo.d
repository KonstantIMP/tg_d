/**
 * Contains TelegramInlineQueryResultCachedPhoto
 */
module tg.inline.types.telegram_inline_query_result_cached_photo;
 ...
 */
class TelegramInlineQueryResultCachedPhoto : TelegramType {
    /**
    ...
    override public void setFromJson (JSONValue data) {
        ...
        if ( "photo_file_id" !in data ) throw new TelegramException("Could not find reqired entry : photo_file_id");
        _photo_file_id = data["photo_file_id"].str();
    ...
    override public JSONValue getAsJson () {
        ...
        data["photo_file_id"] = _photo_file_id;
    ...
    private string _photo_file_id;
    /**
     * Getter for '_photo_file_id'
     * Returns: Current value of '_photo_file_id'
     */
    @property string photoFileId () { return _photo_file_id; }
    /**
     * Setter for '_photo_file_id'
     * Params: photoFileIdNew = New value of '_photo_file_id'
     * Returns: New value of '_photo_file_id'
     */
    @property string photoFileId ( string photoFileIdNew ) { return _photo_file_id = photoFileIdNew; }
