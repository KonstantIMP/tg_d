/**
 * Contains TelegramInlineQueryResultCachedVoice
 */
module tg.inline.types.telegram_inline_query_result_cached_voice;
 ...
 */
class TelegramInlineQueryResultCachedVoice : TelegramType {
    /**
    ...
    override public void setFromJson (JSONValue data) {
        ...
        if ( "voice_file_id" !in data ) throw new TelegramException("Could not find reqired entry : voice_file_id");
        _voice_file_id = data["voice_file_id"].str();
    ...
    override public JSONValue getAsJson () {
        ...
        data["voice_file_id"] = _voice_file_id;
    ...
    private string _voice_file_id;
    /**
     * Getter for '_voice_file_id'
     * Returns: Current value of '_voice_file_id'
     */
    @property string voiceFileId () { return _voice_file_id; }
    /**
     * Setter for '_voice_file_id'
     * Params: voiceFileIdNew = New value of '_voice_file_id'
     * Returns: New value of '_voice_file_id'
     */
    @property string voiceFileId ( string voiceFileIdNew ) { return _voice_file_id = voiceFileIdNew; }
