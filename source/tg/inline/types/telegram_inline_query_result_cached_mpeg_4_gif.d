/**
 * Contains TelegramInlineQueryResultCachedMpeg4Gif
 */
module tg.inline.types.telegram_inline_query_result_cached_mpeg_4_gif;
 ...
 */
class TelegramInlineQueryResultCachedMpeg4Gif : TelegramType {
    /**
    ...
    override public void setFromJson (JSONValue data) {
        ...
        if ( "mpeg4_file_id" !in data ) throw new TelegramException("Could not find reqired entry : mpeg4_file_id");
        _mpeg4_file_id = data["mpeg4_file_id"].str();
    ...
    override public JSONValue getAsJson () {
        ...
        data["mpeg4_file_id"] = _mpeg4_file_id;
    ...
    private string _mpeg4_file_id;
    /**
     * Getter for '_mpeg4_file_id'
     * Returns: Current value of '_mpeg4_file_id'
     */
    @property string mpeg4FileId () { return _mpeg4_file_id; }
    /**
     * Setter for '_mpeg4_file_id'
     * Params: mpeg4FileIdNew = New value of '_mpeg4_file_id'
     * Returns: New value of '_mpeg4_file_id'
     */
    @property string mpeg4FileId ( string mpeg4FileIdNew ) { return _mpeg4_file_id = mpeg4FileIdNew; }
