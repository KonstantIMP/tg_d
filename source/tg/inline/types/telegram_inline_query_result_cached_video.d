/**
 * Contains TelegramInlineQueryResultCachedVideo
 */
module tg.inline.types.telegram_inline_query_result_cached_video;
 ...
 */
class TelegramInlineQueryResultCachedVideo : TelegramType {
    /**
    ...
    override public void setFromJson (JSONValue data) {
        ...
        if ( "video_file_id" !in data ) throw new TelegramException("Could not find reqired entry : video_file_id");
        _video_file_id = data["video_file_id"].str();
    ...
    override public JSONValue getAsJson () {
        ...
        data["video_file_id"] = _video_file_id;
    ...
    private string _video_file_id;
    /**
     * Getter for '_video_file_id'
     * Returns: Current value of '_video_file_id'
     */
    @property string videoFileId () { return _video_file_id; }
    /**
     * Setter for '_video_file_id'
     * Params: videoFileIdNew = New value of '_video_file_id'
     * Returns: New value of '_video_file_id'
     */
    @property string videoFileId ( string videoFileIdNew ) { return _video_file_id = videoFileIdNew; }
