/**
 * Contains TelegramInlineQueryResultAudio
 */
 ...
 */
class TelegramInlineQueryResultAudio : TelegramType {
    /**
    ...
    override public void setFromJson (JSONValue data) {
        ...
        if ( "audio_url" !in data ) throw new TelegramException("Could not find reqired entry : audio_url");
        _audio_url = data["audio_url"].str();
        ...
        _audio_duration = data["audio_duration"].integer();
    ...
    override public JSONValue getAsJson () {
        ...
        if ( _audio_duration != 0 ) data["audio_duration"] = _audio_duration;
    ...
    /**
     * Getter for '_audio_url'
     * Returns: Current value of '_audio_url'
     */
    @property string audioUrl () { return _audio_url; }
    /**
     * Setter for '_audio_url'
     * Params: audioUrlNew = New value of '_audio_url'
     * Returns: New value of '_audio_url'
     */
    @property string audioUrl ( string audioUrlNew ) { return _audio_url = audioUrlNew; }
    ...
    private ulong _audio_duration;
    /**
     * Getter for '_audio_duration'
     * Returns: Current value of '_audio_duration'
     */
    @property ulong audioDuration () { return _audio_duration; }
    /**
     * Setter for '_audio_duration'
     * Params: audioDurationNew = New value of '_audio_duration'
     * Returns: New value of '_audio_duration'
     */
    @property ulong audioDuration ( ulong audioDurationNew ) { return _audio_duration = audioDurationNew; }
